#!/bin/bash
#SBATCH --output=/home/rajd2/rds/hpc-work/snRNAseq_2026/logs/tune_scvi_dryrun_%j.out
#SBATCH --error=/home/rajd2/rds/hpc-work/snRNAseq_2026/logs/tune_scvi_dryrun_%j.err
...
CONFIG="${CONFIG:-code/tuning/test_tuning_config.yaml}"

mkdir -p "${WORK_DIR}/logs"

echo "========================================"
echo "scVI tuning DRY-RUN (2 trials, 5k cells)"

...
echo ""
echo "Next: run pseudobulk + notebook, then diagnostics:"
echo "  sbatch --export=ALL,WORK_DIR=${WORK_DIR},CONFIG=<pipeline_config.yaml> \\"
echo "         code/pipeline/slurm/step3_pseudobulk.sh"
echo "  # then: step4_notebook.sh (if notebook: section in config), step5_diagnostics.sh"

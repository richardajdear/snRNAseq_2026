#!/bin/bash
#SBATCH --job-name=DS_HBCC_100k
#SBATCH --output=logs/downsample_hbcc_100k_%j.out
#SBATCH --error=logs/downsample_hbcc_100k_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="/home/rajd2/rds/hpc-work/snRNAseq_2026/scripts/downsample.py"

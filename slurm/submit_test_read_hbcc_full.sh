#!/bin/bash
#SBATCH --job-name=Test_HBCC_Full
#SBATCH --output=logs/test_hbcc_full_%j.out
#SBATCH --error=logs/test_hbcc_full_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="/home/rajd2/rds/hpc-work/snRNAseq_2026/scripts/test_read_hbcc.py"

mkdir -p logs

echo "Testing reading FULL HBCC Cohort..."
date

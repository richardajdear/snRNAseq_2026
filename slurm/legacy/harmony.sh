...
#SBATCH --output=/home/rajd2/rds/hpc-work/snRNAseq_2026/logs/postnatal_part2_full_%j.out
#SBATCH --error=/home/rajd2/rds/hpc-work/snRNAseq_2026/logs/postnatal_part2_full_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1

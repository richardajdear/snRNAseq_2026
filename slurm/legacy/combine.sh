...
#SBATCH --output=/home/rajd2/rds/hpc-work/snRNAseq_2026/logs/combine_%j.out
#SBATCH --error=/home/rajd2/rds/hpc-work/snRNAseq_2026/logs/combine_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "========================================================"
echo "Starting Combine Job (Full Downsampled Data)"
